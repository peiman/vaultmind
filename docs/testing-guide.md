...
> _This page documents the underlying ckeletin-go framework scaffold, not VaultMind's runtime._
...
- [ADR-003: Testing Strategy](../.ckeletin/docs/adr/003-dependency-injection-over-mocking.md) - Testing philosophy and rationale
- [ADR-001: Command Pattern](../.ckeletin/docs/adr/001-ultra-thin-command-pattern.md) - How to write thin, testable commands
