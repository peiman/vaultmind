...
**Aliases provide flexible access.** The `aliases` frontmatter field lets a note be resolved by multiple names. [[entity-resolution|Entity Resolution]] uses aliases to detect and merge duplicate notes that refer to the same concept under different titles.
