...
The central insight is that language itself can serve as the update signal, making improvement interpretable and reversible in a way gradient descent is not. The episodic memory buffer plays the role of a personal error log—a structured record that shapes future reasoning without overwriting prior knowledge. This connects directly to [[Reflexion]] as a vault concept and offers a template for how agents should handle correction and revision over time.
