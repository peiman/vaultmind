...
This paper is the practical foundation of the modern diffusion era. Almost every subsequent text-to-image and video diffusion system — GLIDE, DALL-E 2, [[latent-diffusion|Stable Diffusion]], Imagen, Sora — inherits the ε-prediction objective and the U-Net denoiser pattern that DDPM established.
