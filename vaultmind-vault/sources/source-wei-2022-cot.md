...
The paper defined a research program on prompt-engineered reasoning, motivated zero-shot CoT ("Let's think step by step"), and is the lineage point for [[tree-of-thought|Tree-of-Thoughts]], self-consistency, and the broader inference-time-compute paradigm.
