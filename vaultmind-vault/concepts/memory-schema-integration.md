...
- **Connection to creativity:** The schema-building process provides the multi-night substrate for creative insight (see [[concept-rem-creativity-insight|REM Creativity and Insight]]): each night of sleep expands the schematic network that REM can traverse associatively.

## Connections

Memory schema integration is a specialised downstream outcome of [[concept-memory-consolidation|Memory Consolidation]] and [[concept-memory-replay|Memory Replay]]. It depends mechanistically on [[concept-sharp-wave-ripples|Sharp-Wave Ripples]] for hippocampal-neocortical transfer and on sleep spindles for cortical synaptic plasticity (forward ref: [[concept-sleep-spindles|Sleep Spindles]]). The resulting schemas are the schematic substrate from which [[concept-rem-creativity-insight|REM Creativity]] derives its insight leaps. Dream content in [[concept-dream-content-memory|Dream Content and Memory]] reflects these schemas rather than intact episodic memory, because schema-level representations are what remain after the extraction process.
