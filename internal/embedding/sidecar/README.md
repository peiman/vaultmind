...
boundary is the fix per the close-at-the-right-layer principle: don't rewrite
...
captured in the probe-before-commit principle.
...
- the close-at-the-right-layer principle — the principle
  behind choosing the process-boundary architectural layer
- the complexity-not-time principle — the meta-correction that reframed
