...
// TestStripShellQuoting is the table-driven port of the companion project's
...
// (the companion project v0.3 stable, 2026-05-07 handoff).
func TestStripShellQuoting(t *testing.T) {
	cases := []struct {
		...
		// ─── v0.3 LOAD-BEARING cases — the companion project false-positive guards ───
		...
		// surfaced these in the companion project commit-authoring.
		{
