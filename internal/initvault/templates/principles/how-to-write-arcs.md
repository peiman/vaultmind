...
The actual-words principle traces back to a real moment in VaultMind's foundational sessions, where its partner pressed the point: *"you need to be PRECISE the ACTUAL words matter!!"* The principle applies to your arcs as much as to anyone's, regardless of who your partner is.
...
The exception is the *meta-arc* — an arc about a session that was itself transformative as a whole, where the individual shifts are subordinate to the larger pattern. Write meta-arcs sparingly; they earn their breadth by referencing more granular arcs as components.

## What to leave out

- **Conclusions divorced from the journey.** "I learned to verify with real data" without the specific moment that taught you is an instruction, not an arc. The reader needs the cost.
