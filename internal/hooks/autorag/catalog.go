...
//
// Origin: workhorse v0.3 stable handoff 2026-05-07. The shim outline
// in /tmp/workhorse-asks-vaultmind-auto-rag-v03-stable.md showed
...
//
// JSON field names match the workhorse v0.3 shim outline.
...
// workhorse v0.3 DRIFT_CATALOG export shape).
type Catalog struct {
...
// permissionDecision=ask on Write/Edit (workhorse dogfood finding,
