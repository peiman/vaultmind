...
func ExperimentsOptions() []config.ConfigOption {
	return []config.ConfigOption{
		...
		{Key: "experiments.telemetry", DefaultValue: "anonymous", Description: "What export may emit — anonymous (strips vault paths, query text, note ids, result paths, caller_meta) | full | off (nothing is written locally either)", Type: "string"},
