...
func ExperimentsOptions() []config.ConfigOption {
	return []config.ConfigOption{
		...
		{Key: "experiments.telemetry", DefaultValue: "anonymous", Description: "What export may emit — anonymous (strips query text, vault path, note ids) | full | off (nothing is written locally either)", Type: "string"},
