...
var ArcCandidatesMetadata = config.CommandMetadata{
	...
	Long: "Scan the vault and surface candidate transformation moments for arc distillation. " +
		...
		"To find turning points in sessions, `vaultmind arc review` is the stronger tool: " +
		"measured on real sessions, the phrase rules here found 0 of 5 moments that became " +
		"arcs; an agent reading the review list found 4 of 5.",
