...
func TestNormalizePaths(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input:    "/Users/me/dev/ckeletin-go/internal/config/validator.go",
			expected: "./internal/config/validator.go",
		},
		{
			name:     "absolute path with line number",
			input:    "/Users/me/dev/ckeletin-go/cmd/root.go:42",
			expected: "./cmd/root.go:42",
		},
		{
			name:     "multiple paths in output",
			input:    "Error in /Users/me/dev/ckeletin-go/internal/logger/logger.go:15 and /Users/me/dev/ckeletin-go/cmd/version.go:8",
...
func TestNormalizeCheckOutput(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input: `/Users/me/dev/ckeletin-go/internal/config/validator.go:26
...
`,
		},
		{
			...
			input: `Error in /Users/me/dev/ckeletin-go/cmd/root.go:10
